<?php
	...
	*/
	...
	while ( $aRow = $rResult->fetch_assoc() ) {
		...
		$btn = "<center><button class='btn btn-info btn-sm' data-toggle='modal' data-target='.modal-servis' title='Detail' onclick='showDetail($aRow[id_servis])'><i class='fa fa-eye'></i></button></center>";
